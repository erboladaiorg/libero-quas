# @erboladaiorg/libero-quas

![CI](https://github.com/erboladaiorg/libero-quas/workflows/CI/badge.svg)
[![NPM version](https://img.shields.io/npm/v/@erboladaiorg/libero-quas.svg?style=flat)](https://www.npmjs.com/package/@erboladaiorg/libero-quas)
[![js-standard-style](https://img.shields.io/badge/code%20style-standard-brightgreen.svg?style=flat)](https://standardjs.com/)
[![NPM downloads](https://img.shields.io/npm/dm/@erboladaiorg/libero-quas.svg?style=flat)](https://www.npmjs.com/package/@erboladaiorg/libero-quas)


__@erboladaiorg/libero-quas__ is significantly faster than `JSON.stringify()` for small payloads.
...
@erboladaiorg/libero-quas requires a [JSON Schema Draft 7](https://json-schema.org/specification-links.html#draft-7) input to generate a fast `stringify` function.
...
@erboladaiorg/libero-quas array default x 6,243 ops/sec ±0.14% (98 runs sampled)
@erboladaiorg/libero-quas array json-stringify x 6,261 ops/sec ±0.30% (99 runs sampled)
...
@erboladaiorg/libero-quas large array default x 99.96 ops/sec ±0.22% (74 runs sampled)
@erboladaiorg/libero-quas large array json-stringify x 248 ops/sec ±0.07% (90 runs sampled)
...
@erboladaiorg/libero-quas long string x 15,979 ops/sec ±0.09% (96 runs sampled)
...
@erboladaiorg/libero-quas short string x 30,585,790 ops/sec ±0.27% (97 runs sampled)
...
@erboladaiorg/libero-quas obj x 6,866,434 ops/sec ±0.11% (100 runs sampled)
...
@erboladaiorg/libero-quas date format x 1,836,188 ops/sec ±0.12% (99 runs sampled)
...
<a name="example"></a>
Try it out on RunKit: <a href="https://runkit.com/npm/@erboladaiorg/libero-quas">https://runkit.com/npm/@erboladaiorg/libero-quas</a>
## Example

```js
const fastJson = require('@erboladaiorg/libero-quas')
...
Optionally, you may provide to `@erboladaiorg/libero-quas` an option object as second parameter:
...
```
If the object to stringify is missing the required field(s), `@erboladaiorg/libero-quas` will throw an error.

<a name="missingFields"></a>
#### Missing fields
If a field *is present* in the schema (and is not required) but it *is not present* in the object to stringify, `@erboladaiorg/libero-quas` will not write it in the final string.
Example:
```javascript
const stringify = fastJson({
  title: 'Example Schema',
...
<a name="defaults"></a>
#### Defaults
`@erboladaiorg/libero-quas` supports `default` jsonschema key in order to serialize a value
...
#### Pattern properties
`@erboladaiorg/libero-quas` supports pattern properties as defined by JSON schema.
...
`@erboladaiorg/libero-quas` supports additional properties as defined by JSON schema.
...
`@erboladaiorg/libero-quas` supports the **anyOf** and **oneOf** keywords as defined by JSON schema. Both must be an array of valid JSON schemas. The different schemas will be tested in the specified order. The more schemas `stringify` has to try before finding a match, the slower it will be.
...
#### If/then/else
`@erboladaiorg/libero-quas` supports `if/then/else` jsonschema feature. See [ajv documentation](https://ajv.js.org/keywords.html#ifthenelse).
...
```
If you need to use an external definition, you can pass it as an option to `@erboladaiorg/libero-quas`.
Example:
```javascript
const schema = {
  title: 'Example Schema',
...
`@erboladaiorg/libero-quas` to handle arrays starts increasing exponentially, leading
...
@erboladaiorg/libero-quas large array default x 48.72 ops/sec ±4.92% (48 runs sampled)
@erboladaiorg/libero-quas large array json-stringify x 157 ops/sec ±0.76% (86 runs sampled)
...
To achieve low cost and high performance redaction `@erboladaiorg/libero-quas`
...
Users are responsible for sending trusted data. `@erboladaiorg/libero-quas` guarantees that you will get
...
itself. You need to have `@erboladaiorg/libero-quas` installed for the standalone code to work.
